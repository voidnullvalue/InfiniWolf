...
connected by corridors routed around a one-rock buffer; a later commit adds the
repair passes that fix accidental sightlines, oversized sound zones and pinched
doorways.
...
from .grid import (_FLOOR_OR_DOOR, _at, _inside_room, _is_floor, _overlaps,
                   _set)
from .model import FloorPlan, PlacedPlan, Room
from .wl6 import DOOR_EW, DOOR_NS, DOORS, FLOOR, GRID, WALL
