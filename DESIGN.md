...
| Rooms per map (mean) | 24.7 | The compact Wolf3D grid targets `min(24, 14 + 2·complexity)` rooms. Local same-district filler recovery raises Normal realization from roughly 16.3 to 18.1 rooms while retaining the elevator-safe rock shell. |
